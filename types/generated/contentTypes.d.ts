...
export interface ApiMemberSchoolMemberSchool
  extends Struct.CollectionTypeSchema {
  collectionName: 'member_schools';
  info: {
    displayName: 'Member School';
    pluralName: 'member-schools';
    singularName: 'member-school';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::member-school.member-school'
    > &
      Schema.Attribute.Private;
...
export interface ApiParishParish extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    tabHistory: Schema.Attribute.RichText;
    tabMaps: Schema.Attribute.RichText;
    tabPatrons: Schema.Attribute.RichText;
    tabSchedules: Schema.Attribute.RichText;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vicariate: Schema.Attribute.Enumeration<
      [
        'San Roque',
        'Sacred Heart',
        'Our Lady of Grace',
...
export interface ApiPersonPerson extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<['KADSA', 'Clergy']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::member-school.member-school': ApiMemberSchoolMemberSchool;
